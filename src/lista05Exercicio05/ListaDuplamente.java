...
public class ListaDuplamente
{
	...
	/*05) Crie uma função recursiva que verifica se duas listas duplamente encadeadas são iguais.*/
	public boolean iguaisRecursivo(ListaDuplamente lista1, ListaDuplamente lista2) {
		
		if(lista1.vazia() && lista2.vazia()) {
			return true;
		}
		
		return iguaisRecursivo(lista1.prim, lista2.prim);
	}
	private boolean iguaisRecursivo(Elo p1, Elo p2) {
		if(p1.dado != p2.dado) {
			return false;
		}
		...
		return iguaisRecursivo(p1.prox, p2.prox);
	}
}